...
const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'passed', component: PassedComponent, canActivate: [AuthGuard], data: { title: 'Passed', roles: ['VE1', 'AP'], queueModule: 'ADV', queueState: 'PS' } },
      ...
      { path: 'not-passed', component: NotPassedComponent, canActivate: [AuthGuard], data: { title: 'Not Passed', roles: ['VE1', 'AP'], queueModule: 'ADV', queueState: 'NP' } },
      ...
      { path: 'form-pay-details', component: FormPayDetailComponent, canActivate: [AuthGuard], data: { title: 'Pay Detail', roles: ['VE1', 'VE2'] } },
