...
export class ClaimFormPmtDutyComponent implements OnInit {
  ...
  get allSectionsReviewed(): boolean {
    ...
    return this.form1 && this.form2 && this.form3 && this.form4 && bankReviewed && remarksReviewed;
  }
  ...
  openPreview(): void {
    ...
    const url = `${this.$auth.getModuleName()}/preview-pmt-duty-claim?id=${encodeURIComponent(this.claimId)}&subFormId=${encodeURIComponent(this.subFormId)}`;
  ...
  get claimDetails(): any {
    return this.formObj?.yatPermDutyClaimDTOs?.[0];
  }
  ...
  get transportRows(): any[] {
    return Array.isArray(this.claimDetails?.yatPermDutyClaimTransportDTOs) ? this.claimDetails.yatPermDutyClaimTransportDTOs : [];
  }

  get shipEffectRows(): any[] {
    return Array.isArray(this.claimDetails?.yatPermDutyClaimShipEffDTOs) ? this.claimDetails.yatPermDutyClaimShipEffDTOs : [];
  }

  get transportConveyanceRows(): any[] {
    return Array.isArray(this.claimDetails?.yatPermDutyClaimTransportConveyanceDTOs) ? this.claimDetails.yatPermDutyClaimTransportConveyanceDTOs : [];
  }

  get shipConveyanceRows(): any[] {
    return Array.isArray(this.claimDetails?.yatPermDutyClaimShipConveyanceDTOs) ? this.claimDetails.yatPermDutyClaimShipConveyanceDTOs : [];
  }
