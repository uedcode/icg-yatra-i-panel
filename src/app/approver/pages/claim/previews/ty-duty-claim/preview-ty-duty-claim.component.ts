...
@Component({
  selector: 'app-approver-preview-ty-duty-claim',
  templateUrl: './preview-ty-duty-claim.component.html',
  styleUrls: ['./preview-ty-duty-claim.component.scss'],
  standalone: false,
})
export class ClaimPreviewTyDutyComponent implements OnInit {
