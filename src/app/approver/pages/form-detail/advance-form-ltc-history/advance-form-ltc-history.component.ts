...
@Component({
  selector: 'app-approver-advance-form-ltc-history',
  templateUrl: './advance-form-ltc-history.component.html',
  styleUrls: ['./advance-form-ltc-history.component.scss'],
  standalone: false,
})
export class AdvanceFormLtcHistoryComponent implements OnInit {
