...
@Component({
  selector: 'app-form-advance-detail',
  templateUrl: './form-advance-detail.component.html',
  styleUrls: ['./form-advance-detail.component.css'],
  standalone: false,
})
export class FormAdvanceDetailComponent implements OnInit {
