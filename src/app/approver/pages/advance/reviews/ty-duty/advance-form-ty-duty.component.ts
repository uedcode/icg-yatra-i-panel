...
@Component({
  selector: 'app-approver-advance-form-ty-duty',
  templateUrl: './advance-form-ty-duty.component.html',
  styleUrls: ['./advance-form-ty-duty.component.scss'],
  standalone: false,
})
export class AdvanceFormTyDutyComponent implements OnInit {
