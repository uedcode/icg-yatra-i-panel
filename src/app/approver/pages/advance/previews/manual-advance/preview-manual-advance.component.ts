...
@Component({
  selector: 'app-approver-preview-manual-advance',
  templateUrl: './preview-manual-advance.component.html',
  styleUrls: ['./preview-manual-advance.component.scss'],
  standalone: false,
})
export class AdvancePreviewManualComponent implements OnInit {
