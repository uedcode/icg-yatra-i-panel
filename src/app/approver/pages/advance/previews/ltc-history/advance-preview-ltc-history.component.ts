...
@Component({
  selector: 'app-approver-advance-preview-ltc-history',
  templateUrl: './advance-preview-ltc-history.component.html',
  styleUrls: ['./advance-preview-ltc-history.component.scss'],
  standalone: false,
})
