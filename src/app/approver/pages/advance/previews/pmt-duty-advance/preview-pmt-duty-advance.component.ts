...
@Component({
  selector: 'app-approver-preview-pmt-duty-advance',
  templateUrl: './preview-pmt-duty-advance.component.html',
  styleUrls: ['./preview-pmt-duty-advance.component.scss'],
  standalone: false,
})
export class AdvancePreviewPmtDutyComponent implements OnInit {
  ...
  private resolvePreviewSubFormId(routePath: string): string {
  ...
  showFinancialSection(): boolean {
    if (this.previewMode) return this.subFormId !== 'M' && !this.isLtcHistory();
