...
@Component({
  selector: 'app-claim-preview-pmt-duty',
  templateUrl: './claim-preview-pmt-duty.component.html',
  styleUrls: ['./claim-preview-pmt-duty.component.scss'],
  standalone: false,
})
export class ClaimPreviewPmtDutyComponent implements OnInit {
  readonly previewTitle = 'Requisition for PMT Duty Claim';
  ...
  private parseClaimPreviewResponse(response: any): void {
    ...
    this.formObj = claims;
    this.claim = this.firstItem(claims?.yatPermDutyClaimDTOs || claims?.yatPermDutyClaimDTO || claims?.permDutyClaimDTOs);
